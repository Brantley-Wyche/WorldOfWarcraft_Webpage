...
Finally, I will be updating the access token every 24 hours to maintain functionality.  Currently it is set to expire around 1:50am everyday, so that gives plenty of time to test the website.
